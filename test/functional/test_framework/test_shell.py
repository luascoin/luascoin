...
class TestShell:
    """Wrapper Class for LuascoinTestFramework.

    The TestShell class extends the LuascoinTestFramework
    ...
    class __TestShell(LuascoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by LuascoinTestFramework child class.
            self.num_nodes = 1
