...
class FullBlockTest(LuascoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b28 chain to make sure luascoind isn't accepting b28
        ...
        # luascoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the luascoin code has custom code which does so);
