...
"""Verify that starting luascoin with -h works as expected."""

from test_framework.test_framework import LuascoinTestFramework
from test_framework.util import assert_equal

class HelpTest(LuascoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start luascoin with -h for help text")
        ...
        self.log.info("Start luascoin with -version for version information")
        ...
        self.log.info("Start luascoind with -fakearg to make sure it does not start")
