...
By default, luascoind will dump mempool on shutdown and
...
class MempoolPersistTest(LuascoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent luascoind from writing mempool.dat to disk. Verify that `savemempool` fails")
