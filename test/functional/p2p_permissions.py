...
class P2PPermissionsTests(LuascoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].luascoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].luascoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
