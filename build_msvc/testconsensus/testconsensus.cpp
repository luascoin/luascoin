...
// luascoin includes.
#include <..\src\script\luascoinconsensus.h>
...
int main()
{
    std::cout << "luascoinconsensus version: " << luascoinconsensus_version() << std::endl;
    ...
    auto op0Result = luascoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, luascoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
