# Bootstrappable Luascoin Core Builds

This directory contains the files necessary to perform bootstrappable Luascoin
Core builds.
...
- 24GB of free disk space on the partition that the Luascoin Core git repository
  resides in
...
For a Luascoin Core depends development environment, simply invoke
...
From the top of a clean Luascoin Core repository:
...
To use dongcarl's substitute server for Luascoin Core builds after having
