...
(define* (make-luascoin-cross-toolchain target
                                  #:key
...
desirable for building Luascoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-luascoin-cross-toolchain "i686-linux-gnu")
       (make-luascoin-cross-toolchain "x86_64-linux-gnu")
       (make-luascoin-cross-toolchain "aarch64-linux-gnu")
       (make-luascoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-luascoin-cross-toolchain "riscv64-linux-gnu"
