...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the luascoin repository."
  exit 1
fi
...
# See https://github.com/luascoin/luascoin/issues/16064
...
echo 'When compiling luascoind, run `./configure` in the following way:'
echo
