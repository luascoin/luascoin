...
#ifndef LUASCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define LUASCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@luascoin.
 *
 ...
 *
 * The chacha20-poly1305@luascoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@luascoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@luascoin are relatively fast in
...
#endif // LUASCOIN_CRYPTO_CHACHA_POLY_AEAD_H
