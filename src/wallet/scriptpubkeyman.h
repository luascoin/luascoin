...
#ifndef LUASCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define LUASCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Luascoin Core wallet was originally a collection of unrelated private
...
#endif // LUASCOIN_WALLET_SCRIPTPUBKEYMAN_H
