...
{
    // If wallet doesn't have a chain (e.g luascoin-wallet), lock can't be taken.
    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/luascoin/luascoin/pull/14711#issuecomment-458342518
...
DBErrors CWallet::LoadWallet(bool& fFirstRunRet)
{
    ...
    // tx status. If lock can't be taken (e.g luascoin-wallet), tx confirmation
 ...
 * https://luascointalk.org/?topic=54527, or
 * https://github.com/luascoin/luascoin/pull/1393.
 */
