    ...
    mapper(nullptr)
{
    ...
    ui->luascoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->luascoinAtStartup);
    ...
    ui->luascoinAtStartup->setToolTip(ui->luascoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->luascoinAtStartup->setText(ui->luascoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openLuascoinConfButton->setToolTip(ui->openLuascoinConfButton->toolTip().arg(PACKAGE_NAME));
...
void OptionsDialog::on_openLuascoinConfButton_clicked()
{
