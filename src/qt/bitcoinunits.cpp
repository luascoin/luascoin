...
QString LuascoinUnits::longName(int unit)
{
    switch(unit)
    {
...
QString LuascoinUnits::shortName(int unit)
{
    switch(unit)
    {
...
QString LuascoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Luascoins");
    case mBTC: return QString("Milli-Luascoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Luascoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
QString LuascoinUnits::getAmountColumnTitle(int unit)
{
    ...
    {
        amountTitle += " ("+LuascoinUnits::shortName(unit) + ")";
    }
    return amountTitle;
}
