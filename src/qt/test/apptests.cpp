...
//! Entry point for LuascoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &LuascoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for LuascoinGUI tests.
void AppTests::guiTests(LuascoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &LuascoinGUI::consoleShown, this, &AppTests::consoleTests);
