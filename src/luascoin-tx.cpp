...
static void SetupLuascoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " luascoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  luascoin-tx [options] <hex-tx> [commands]  Update hex-encoded luascoin transaction\n" +
            "or:     luascoin-tx [options] -create [commands]   Create hex-encoded luascoin transaction\n" +
            "\n";
