// Copyright (c) 2019-2020 The Luascoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef LUASCOIN_UTIL_SETTINGS_H
#define LUASCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/luascoin/luascoin/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored luascoin settings. This struct combines settings from the command line
...
#endif // LUASCOIN_UTIL_SETTINGS_H
