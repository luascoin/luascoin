...
#ifndef LUASCOIN_INTERFACES_NODE_H
#define LUASCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a luascoin node (luascoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // LUASCOIN_INTERFACES_NODE_H
