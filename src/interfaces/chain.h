...
#ifndef LUASCOIN_INTERFACES_CHAIN_H
#define LUASCOIN_INTERFACES_CHAIN_H
...
//! internal workings of the luascoin node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/luascoin/luascoin/pull/10973#issuecomment-380101269).
//!
//! * The initMessage() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/luascoin/luascoin/pull/15288#discussion_r253321096).
//!
...
#endif // LUASCOIN_INTERFACES_CHAIN_H
