...
{
    BOOST_CHECK(TestSplitHost("www.luascoincore.org", "www.luascoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.luascoincore.org]", "www.luascoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.luascoincore.org:80", "www.luascoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.luascoincore.org]:80", "www.luascoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:10153", "127.0.0.1", 10153));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:10153", "127.0.0.1", 10153));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:10153", "::ffff:127.0.0.1", 10153));
    BOOST_CHECK(TestSplitHost("[::]:10153", "::", 10153));
    BOOST_CHECK(TestSplitHost("::10153", "::10153", -1));
    BOOST_CHECK(TestSplitHost(":10153", "", 10153));
    BOOST_CHECK(TestSplitHost("[]:10153", "", 10153));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:10153", "127.0.0.1:10153"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:10153", "[::]:10153"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
