...
```
git clone https://github.com/luascoin-core/qa-assets
...
To build Luascoin Core using AFL instrumentation (this assumes that the
...
with certain assembly code from Luascoin Core's code. See [developer notes on sanitizers](https://github.com/luascoin/luascoin/blob/master/doc/developer-notes.md#sanitizers)
