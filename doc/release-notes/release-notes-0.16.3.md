Luascoin Core version 0.16.3 is now available from:

  <https://luascoincore.org/bin/luascoin-core-0.16.3/>
...
been discovered in Luascoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` luascoinconsensus: invalid flags error should be set to `luascoinconsensus_err` (afk11)
