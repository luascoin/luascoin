Luascoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/luascoin/files/Luascoin/luascoin-0.5.4/
...
http://gitorious.org/luascoin/luascoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Luascoin-Qt notifications under Growl 1.3.
Increase required age of Luascoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLuascoin properly when installing Luascoin-Qt over it. (Windows)
