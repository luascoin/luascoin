Luascoin Core version 0.13.2 is now available from:

  <https://luascoin.org/bin/luascoin-core-0.13.2/>
...
- #8908 `4a974b2` Update luascoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow luascoin-tx to create v2 transactions (btcdrak)
