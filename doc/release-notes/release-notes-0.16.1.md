Luascoin Core version 0.16.1 is now available from:

  <https://luascoincore.org/bin/luascoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting luascoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure luascoind processes are cleaned up when tests end (sdaftuar)
