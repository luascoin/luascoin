Luascoin Core version *0.15.2* is now available from:

  <https://luascoincore.org/bin/luascoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in luascoin-tx (TheBlueMatt)
