Luascoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/luascoin/files/Luascoin/luascoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Luascoin
...
New/changed settings (command-line or luascoin.conf file)
--------------------------------------------------------
