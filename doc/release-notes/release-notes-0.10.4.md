Luascoin Core version 0.10.4 is now available from:

  <https://luascoin.org/bin/luascoin-core-0.10.4/>
...
- #6953 `43c2789` Split luascoin-tx into its own package
- #6953 `dfe0d4d` Include luascoin-tx binary on Debian/Ubuntu
