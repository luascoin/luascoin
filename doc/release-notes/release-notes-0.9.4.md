Luascoin Core version 0.9.4 is now available from:

  https://luascoin.org/bin/0.9.4/
...
this update is incompatible with the Luascoin system and could lead to consensus
forks.

Luascoin Core released binaries from https://luascoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~luascoin/+archive/ubuntu/luascoin
- A third-party or self-compiled Luascoin Core

upgrade to Luascoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
